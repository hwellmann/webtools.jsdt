...
import org.eclipse.wst.jsdt.debug.internal.nashorn.jsdi.NashornMirror;
 ...
 * @since 1.0
 */
public class NashornEventRequest extends NashornMirror implements EventRequest {
	 ...
	 * @param vm
	 */
	public NashornEventRequest(NashornVirtualMachine vm) {
		super(vm);
	}
