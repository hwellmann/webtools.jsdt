 ...
 * @since 1.0
 */
public class NashornDebuggerStatementRequest extends NashornEventRequest implements DebuggerStatementRequest {
	 ...
	 * @param vm
	 */
	public NashornDebuggerStatementRequest(NashornVirtualMachine vm) {
		super(vm);
	}
