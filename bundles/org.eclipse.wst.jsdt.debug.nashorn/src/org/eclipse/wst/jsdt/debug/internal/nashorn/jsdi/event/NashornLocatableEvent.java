 ...
 * @since 1.0
 */
public class NashornLocatableEvent extends NashornEvent implements LocatableEvent {
	 ...
	 * @param request
	 */
	public NashornLocatableEvent(NashornVirtualMachine vm, ThreadReference thread, Location location, EventRequest request) {
		super(vm, request);
		this.thread = thread;
