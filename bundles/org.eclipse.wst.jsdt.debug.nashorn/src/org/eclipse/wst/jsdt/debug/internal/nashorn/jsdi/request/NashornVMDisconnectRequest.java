 ...
 * @since 1.0
 */
public class NashornVMDisconnectRequest extends NashornEventRequest implements VMDisconnectRequest {

	/**
	 * Constructor
	 * @param vm
	 */
	public NashornVMDisconnectRequest(NashornVirtualMachine vm) {
		super(vm);
	}
}