 ...
 * @since 1.1
 */
public class NashornResumeRequest extends NashornEventRequest implements ResumeRequest {
	 ...
	 * @param thread
	 */
	public NashornResumeRequest(NashornVirtualMachine vm, ThreadReference thread) {
		super(vm);
		this.thread = thread;
	}
