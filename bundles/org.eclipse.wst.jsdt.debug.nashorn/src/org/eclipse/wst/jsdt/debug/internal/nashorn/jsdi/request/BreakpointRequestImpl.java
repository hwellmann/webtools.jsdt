 ...
 * @since 1.0
 */
public class BreakpointRequestImpl extends NashornEventRequest implements BreakpointRequest {
	 ...
	 * @param location
	 */
	public BreakpointRequestImpl(NashornVirtualMachine vm, Location location) {
		super(vm);
